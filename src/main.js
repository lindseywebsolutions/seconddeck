...
function home() {
  root.innerHTML = pageShell(`<main>
    <section class="hero"><div class="eyebrow"><span></span> Built first for AYN Thor</div>
      ...
      <p class="obtainium">Already see an older source named <strong>App</strong>? Remove that stale entry, then use <strong>Add to Obtainium</strong> again so the full config is saved as SecondDeck. Obtainium reads icons from installed Android apps, so the embedded dual-screen logo appears after the first install.</p>
