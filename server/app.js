...
export function createApp({ config, authService, aiService, deckStore, mailer }) {
  ...
  app.get('/api/config', (_req, res) => res.json({
    name: 'SecondDeck', version: process.env.APP_VERSION || '0.11.0', login: 'email-code', widgetTypes,
    ...
    downloadUrl: `${config.publicUrl}/downloads/seconddeck-v${process.env.APP_VERSION || '0.11.0'}.apk`,
